...
export ONSTAR_TOTP=$(bashio::config 'ONSTAR_TOTP')
export ONSTAR_PIN=$(bashio::config 'ONSTAR_PIN')
export TOKEN_LOCATION=$(bashio::config 'TOKEN_LOCATION')
export ONSTAR_URL=$(bashio::config 'ONSTAR_URL')
export ONSTAR_REFRESH=$(bashio::config 'ONSTAR_REFRESH')
export ONSTAR_RECALL_REFRESH=$(bashio::config 'ONSTAR_RECALL_REFRESH')
...
export ONSTAR_STATE_CACHE=$(bashio::config 'ONSTAR_STATE_CACHE')
export OPENID_CLOCK_TOLERANCE_SEC=$(bashio::config 'OPENID_CLOCK_TOLERANCE_SEC')
...
export MQTT_LIST_ALL_SENSORS_TOGETHER=$(bashio::config 'MQTT_LIST_ALL_SENSORS_TOGETHER')
