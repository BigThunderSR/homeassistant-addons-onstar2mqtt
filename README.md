...
- The OnStar API has rate limiting, so they will block excessive requests over a short period of time. It is recommended that you poll no more often than once every 30 minutes (1800000 milliseconds).
